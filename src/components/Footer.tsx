...
import logo from "@/assets/jeweliq-logo-official.png.asset.json";
...
export const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      />
      {/* Readability overlay */}
      <div className="absolute inset-0 z-0 bg-background/75 dark:bg-background/70 pointer-events-none" />
