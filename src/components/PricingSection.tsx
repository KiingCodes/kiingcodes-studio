      ...
      <div className="text-center mb-8">
        ...
        <div>
          ...
          <div className="text-4xl font-bold text-gradient">
            {plan.price > 0
              ? `R${Number(plan.price).toLocaleString()}`
              : "Custom"}
          </div>
        </div>
      </div>
...
export const PricingSection = () => {
  ...
  return (
    ...
    >
      ...
      <FloatingDiamond
        className="top-20 right-12 opacity-10"
        size="w-20"
        delay={1.5}
      />
      <FloatingDiamond
        className="bottom-20 left-8 opacity-10"
        size="w-14"
        delay={4}
        duration={10}
      />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            ...
            and budget. All prices in South African Rand.
          </p>
        </motion.div>
        ...
        {isLoading ? (
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="bg-card rounded-2xl p-8 border border-border animate-pulse"
              >
